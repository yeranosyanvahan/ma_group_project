...
customer_data = pd.read_csv('data/dim_customer.csv')
...
payment_method_data = pd.read_csv('data/dim_payment_method.csv')
# Uncomment the next line if you want to truncate the table before inserting
...
transaction_data = pd.read_csv('data/fact_transaction.csv')
# Uncomment the next line if you want to truncate the table before inserting
